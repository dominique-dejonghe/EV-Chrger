-- Add Mollie payment fields to users table

-- Step 1: Create new table with Mollie fields
...
CREATE INDEX IF NOT EXISTS idx_users_mollie_customer ON users(mollie_customer_id);
CREATE INDEX IF NOT EXISTS idx_users_mollie_subscription ON users(mollie_subscription_id);
